...
PLANS = [
    ...
    },
    {
        ...
        'inc': [
            ...
            L('Prioridad de ejecución alta', 'High execution priority', 'Prioridade de execução alta'),
        ],
        'addons': [
            L('Atención por evento <b>7×24</b> (costo adicional)',
              '<b>24/7</b> per-event coverage (additional cost)',
    ...
    },
    {
        ...
        'inc': [
            ...
            L('Prioridad de ejecución máxima', 'Highest execution priority', 'Prioridade de execução máxima'),
...
ROWS = [
    ...
    ('row', L('Prioridad de ejecución', 'Execution priority', 'Prioridade de execução'),
     L('Orden de atención cuando hay muchas automatizaciones en cola. A mayor prioridad, menos espera.',
       'Order of service when many automations are queued. Higher priority means less waiting.',
       'Ordem de atendimento quando há muitas automações na fila. Quanto maior a prioridade, menor a espera.'),
    ...
    ('row', L('Usuarios de Control Room', 'Control Room users', 'Usuários do Control Room'),
    ...
    ('row', 'Workspaces',
     L('Espacios de trabajo para organizar apps, automatizaciones y datos por equipo o proyecto.',
       'Workspaces to organize apps, automations and data by team or project.',
       'Espaços de trabalho para organizar apps, automações e dados por time ou projeto.'),
     [T('1'), T(ILIM_OS), T(ILIM_OS), T(ILIM_OS)]),
...
COPY = {
    ...
    'price_note': L('Precios en dólares estadounidenses (U$D). Licencia anual.',
