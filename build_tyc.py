...
<p><strong>Email AI</strong> conecta cuentas Gmail, Outlook, IMAP y POP3 (vía OAuth 2.0 para Gmail/Outlook), interpreta el cuerpo del correo por NLP y extrae campos definidos por el Cliente, disparando acciones posteriores. <strong>Documents AI</strong> convierte PDF y TXT en información estructurada sin necesidad de entrenamiento previo; documentos escaneados sin texto embebido deben procesarse por Image AI. <strong>Voice AI</strong> transcribe audio (MP3/WAV, incluyendo notas de WhatsApp, máx. 25 MB) y extrae datos clave de la transcripción. <strong>Image AI</strong> aplica OCR con IA sobre PNG, JPEG, JPG, WEBP y GIF no animado.</p>
{fmt_table}
...
<p><strong>Email AI</strong> connects Gmail, Outlook, IMAP and POP3 accounts (via OAuth 2.0 for Gmail/Outlook), interprets the email body with NLP and extracts Client-defined fields, triggering follow-up actions. <strong>Documents AI</strong> converts PDF and TXT into structured information without prior training; scanned documents with no embedded text must be processed via Image AI instead. <strong>Voice AI</strong> transcribes audio (MP3/WAV, including WhatsApp voice notes, max. 25 MB) and extracts key data from the transcript. <strong>Image AI</strong> applies AI-powered OCR to PNG, JPEG, JPG, WEBP and non-animated GIF.</p>
{fmt_table}
...
<p>O <strong>Email AI</strong> conecta contas Gmail, Outlook, IMAP e POP3 (via OAuth 2.0 para Gmail/Outlook), interpreta o corpo do e-mail por NLP e extrai campos definidos pelo Cliente, disparando ações posteriores. O <strong>Documents AI</strong> converte PDF e TXT em informações estruturadas sem necessidade de treinamento prévio; documentos digitalizados sem texto incorporado devem ser processados pelo Image AI. O <strong>Voice AI</strong> transcreve áudio (MP3/WAV, incluindo áudios do WhatsApp, máx. 25 MB) e extrai dados-chave da transcrição. O <strong>Image AI</strong> aplica OCR com IA em PNG, JPEG, JPG, WEBP e GIF não animado.</p>
{fmt_table}
